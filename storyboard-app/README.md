# 記憶藝廊 Memory · Gallery — 把長輩的故事留成藝術品

為**失智長輩的回憶喚起（懷舊治療）**設計的線上藝術創作原型：
長輩用說的或打字留下一段回憶，介面把它拆成「起、承、轉、合」
四幕電影分鏡，裱進畫框、附上作品銘牌，成為一件可以收藏、
可以與家人一起翻看的回憶藝術品。

為年長使用者做的設計：整體字級放大（17–18px 基準）、
按鈕與錄音目標加大、文案語氣溫暖不帶測驗感、
提示詞會保留口述中的年份、地名與老物件等「記憶鑰匙」，
並把片段跳躍的口述溫柔整理成有頭有尾的四幕。
